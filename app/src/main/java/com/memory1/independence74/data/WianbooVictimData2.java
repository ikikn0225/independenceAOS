...
public class WianbooVictimData2 {
    ...
    //사진 없는 경우
    public WianbooVictimData2(String wianboovictim_name, String wianboovictim_year) {
        this.wianboovictim_name = wianboovictim_name;
        this.wianboovictim_year = wianboovictim_year;
    }

    //3가지 정보 다 있는 경우
    public WianbooVictimData2(String wianboovictim_name, String wianboovictim_year, int wianboovictim_picture) {
        this.wianboovictim_name = wianboovictim_name;
        this.wianboovictim_year = wianboovictim_year;
